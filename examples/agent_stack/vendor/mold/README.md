...
| `mold.tool_params(model)` | parameters object for tools |
| `mold.tool_spec(name, model, desc?)` | OpenAI `tools[]` entry |
| `mold.input_schema_tool(name, model, desc?)` | Anthropic tool map |
