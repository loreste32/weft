...
- **Generated:** 2026-08-04T04:27:50Z
...
|---------|--------------|----------|
| `warp` | 153 | `packages/warp/weft.json` |
| `dataframe` | 110 | `packages/dataframe/weft.json` |
| `ml` | 65 | `packages/ml/weft.json` |

## Claim summary

- implemented: **16** · partial: **10** · unsupported: **6**
...
| logical dtypes (bool/int64/float32/float64/object) | `implemented` | Logical metadata; not full NumPy casting table |
...
| classical linear / logistic fit + score | `implemented` | CPU minibatch; 100k-row train tested |
